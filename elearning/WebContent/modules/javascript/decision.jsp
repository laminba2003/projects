...
<pre style='color:#000000;background:#ffffff;'>
  <span style='color:#7f0055; font-weight:bold; '>var</span> x = 100;
   <span style='color:#7f0055; font-weight:bold; '>if</span>(x &lt; 20){
      <span style='color:#7f0055; font-weight:bold; '>console</span>.out.print(<span style='color:#2a00ff; '>"x est &lt; à 20"</span>);
...
<pre style='color:#000000;background:#ffffff;'>
   <span style='color:#7f0055; font-weight:bold; '>var</span> grade = <span style='color:#2a00ff; '>'C'</span>;
   <span style='color:#7f0055; font-weight:bold; '>switch</span>(grade) {
         <span style='color:#7f0055; font-weight:bold; '>case</span> <span style='color:#2a00ff; '>'A'</span> :
            <span style='color:#7f0055; font-weight:bold; '>console</span>.log(<span style='color:#2a00ff; '>"Excellent!"</span>); 
         ...
         <span style='color:#7f0055; font-weight:bold; '>case</span> <span style='color:#2a00ff; '>'C'</span> :
            <span style='color:#7f0055; font-weight:bold; '>console</span>.log(<span style='color:#2a00ff; '>"Bravo!"</span>);
            <span style='color:#7f0055; font-weight:bold; '>break</span>;
         <span style='color:#7f0055; font-weight:bold; '>case</span> <span style='color:#2a00ff; '>'D'</span> :
            <span style='color:#7f0055; font-weight:bold; '>console</span>.log(<span style='color:#2a00ff; '>"Vous avez réussi"</span>);
            <span style='color:#7f0055; font-weight:bold; '>break</span>;
         <span style='color:#7f0055; font-weight:bold; '>default</span> :
            <span style='color:#7f0055; font-weight:bold; '>console</span>.log(<span style='color:#2a00ff; '>"grade invalide"</span>);
   }
   <span style='color:#7f0055; font-weight:bold; '>console</span>.log(<span style='color:#2a00ff; '>"votre grade est "</span> + grade);
</pre>
...
<pre style='color:#000000;background:#ffffff;'>
   <span style='color:#7f0055; font-weight:bold; '>var</span> max;
   <span style='color:#7f0055; font-weight:bold; '>var</span> a = 15;
   <span style='color:#7f0055; font-weight:bold; '>var</span> b = 25;
   max = (a > b) ? a : b;
   <span style='color:#7f0055; font-weight:bold; '>console</span>.log(<span style='color:#2a00ff; '>"le max est "</span> + max);
</pre>
<div class="nav">
 	<p><a href="javascript/boucle">&lt; Précédent</a></p>
 	<p><a href="javascript/exception">Suivant &gt;</a></p>
</div>