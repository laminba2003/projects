<h1>Héritage</h1>
<p>
L'<b>héritage</b> est spécifique à la programmation orientée objet. Il consiste à créer une nouvelle classe à partir d'une classe de base et de mettre en place une hiérarchie. La classe dérivée contiendra les attributs et les méthodes de la classe mère.
Un héritage peut être simple ou multiple et certains langages orientés objet supportent les deux types.
</p>
...
<div class="nav">
 	<p><a href="poo/association">&lt; Précédent</a></p>
