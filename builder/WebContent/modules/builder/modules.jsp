...
<fieldset class="extensions-details">
	<div id="extensions">
	   ...
	   <s:iterator value="#application.moduleManager.modules">
		  ...
		  <div class="info">
		  <span class="extension-name">${name}  <a href="builder/modules/edit?id=${id}" title="edit" class="edit-16"></a><a title="delete" class="delete-16"></a><a title="downlad" class="download-16"></a><a title="share" class="share-16"></a></span>
