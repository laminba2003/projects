const display = (div,title,videos) => {
 ...
 document.addEventListener("DOMContentLoaded", () => {
	 ...
	 videos.push({id : "lRrY2_4AKKs", title : "Bell Biv DeVoe - Run"});
	 videos.push({id : "PT4ryVop_Fc", title : "Florida Georgia Line - May We All"});
	 videos.push({id : "h_u9kc3ts_8", title : "Brad Paisley - Without a Fight"});
	 videos.push({id : "04yfcfBfyAo", title : "DI-RECT - Natural High"});
