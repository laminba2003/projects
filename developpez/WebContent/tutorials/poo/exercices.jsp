...
<h2>Exercice 1</h2>
<ul class="tabs"> 
      <li class="active" rel="exo1"><h2>Enoncé</h2></li>
      <li rel="exo1-solution"><h2>Solution</h2></li>
</ul>
    
<div class="tab_container"> 

     <div id="exo1" class="tab_content"> 
 	 <div>
       <ul class="number">
		  <li>Définir une classe Rectangle ayant les attributs suivants : longueur et largeur.</li>
		  <li>Ajouter un constructeur d'initialisation.</li>
		  <li>Définir les accesseurs aux attributs de la classe.</li>
		  <li>Ajouter les méthodes suivantes : 
		  		<ul>
		  			<li> <span class="method">getPerimetre()</span> : retourne le périmètre du rectangle. </li>
		  			 <li> <span class="method">getAire()</span> : retourne l'aire du rectangle.</li>
		  		</ul>
		  </li>
		   <li>Créer un Rectangle</li>
		</ul>
     </div>
     </div>
     <div id="exo1-solution" class="tab_content"> 
      <h2>Rectangle.java</h2>
       <div>
   		<pre style='color:#000000;background:#ffffff;'><span style='color:#7f0055; font-weight:bold; '>public</span> <span style='color:#7f0055; font-weight:bold; '>class</span> Rectangle {
	...
	<span style='color:#7f0055; font-weight:bold; '>public</span> <span style='color:#7f0055; font-weight:bold; '>String</span> toString() {
		<span style='color:#7f0055; font-weight:bold; '>return</span> <span style='color:#2a00ff; '>"Longueur : "</span> + longueur + <span style='color:#2a00ff; '>" - Largeur : "</span> + largeur
				+ <span style='color:#2a00ff; '>" - Perimetre : "</span> + getPerimetre() + <span style='color:#2a00ff; '>" - Aire : "</span>
				+ getAire();
	}
...
<div class="nav">
 	<p><a href="<%=request.getContextPath()%>/poo/pattern">< Previous</a></p>
 	<p><a href="<%=request.getContextPath()%>/poo/classe">Next ></a></p>
</div>